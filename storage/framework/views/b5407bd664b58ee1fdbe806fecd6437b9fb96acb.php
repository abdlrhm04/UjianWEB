    ...
    <div class="flex ms-72 mt-5 class font-inter flex-col">
        <div class="bg-white  w-11/12 h-32 ps-5 pt-5">
            ...
            <div class="grid grid-cols-3  w-2/3 mt-2">
                <div>
                    <p>Total Aktivitas</p>
                    <span class="flex items-center mt-3"><?php echo e($total_aktivitas); ?></span>
                </div>
                <div>
                    <p>Jumlash SKS</p>
                    <span class="flex items-center mt-3"><?php echo e($jumlah_sks); ?></span>
                </div>
                <div>
                    <p>Jumlah Angka Kredit</p>
                    <span class="flex items-center mt-3"><?php echo e($jumlah_angka_kredit); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="relative overflow-x-auto  mt-10 font-inter">
            ...
            <table class="w-11/12 text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        <td class="px-6 py-4">
                            <?php echo e((($aktivitas->currentPage() * 10) - 10) + $loop->iteration); ?>

                        </td>
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <a href="<?php echo e(route('detail-aktivitas', $item->id)); ?>"> <?php echo e($item->nama_aktivitas); ?></a>
                        </th>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4">
                            <?php echo e(ubahFormatTanggal($item->tanggal_mulai)); ?> - <?php echo e(ubahFormatTanggal($item->tanggal_berakhir)); ?>

                        </td>
                        <td class="px-6 py-4">
                            <?php echo e($item->sks_hasil); ?> SKS
                        </td>
                        <td class="px-6 py-4">
                            <?php echo e($item->angka_kredit*$item->jumlah_volume_kegiatan); ?>

                        </td>
                        <td class="px-6 py-4">
                            <?php echo e($item->no_penugasan); ?>

                        </td>
                        <td class="px-6 py-4">
                            <a target="_blank" href="storage/<?php echo e($item->path_lampiran); ?>" class="hover:text-gray-700 hover:underline text-blue-600 font-semibold"><?php echo e($item->jenis_lampiran); ?></a>
                        </td>
                    </tr>
            ...
            <div class="flex flex-col w-11/12">
                <?php echo e($aktivitas->links('pagination::tailwind')); ?>
...
</html><?php /**PATH A:\Codingan\Project Kuliah\Pemrograman Web\sistem-ta\resources\views/aktivitas/aktivitas.blade.php ENDPATH**/ ?>