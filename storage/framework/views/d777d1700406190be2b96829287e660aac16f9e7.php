        ...
        <div class="grid grid-cols-2 bg-white  w-11/12 h-16 ps-5 items-center">
            ...
            <table class="w-11/12 text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    ...
                    <?php $__currentLoopData = $seminar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $i++;
                    ?>
                    <tr>
                        ...
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <a href="<?php echo e(route('detail-aktivitas', $item->id)); ?>"> <?php echo e($item->mahasiswa_nim); ?></a>
                        </th>
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <?php echo e($item->mahasiswa_nama); ?>
                        ...
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <?php echo e(ubahFormatTanggal($item->waktu_seminar)); ?>

                        </th>
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <?php echo e($item->no_berita_acara); ?>

                        </th>
                        <td class="px-6 py-4">
                            <a target="_blank" href="storage/<?php echo e($item->path_lampiran); ?>" class="hover:text-gray-700 hover:underline text-blue-600 font-semibold">Berita Acara</a>
                        </td>
                        <td class="px-6 py-4">
                            <a target="_blank" href="storage/<?php echo e($item->path_foto_kegiatan); ?>" class="hover:text-gray-700 hover:underline text-blue-600 font-semibold">Laporan Kegiatan</a>
                        </td>
                        <td class="px-6 py-4">
                            <a target="_blank" href="seminar/delete/<?php echo e($item->id); ?>" class="hover:text-gray-700 hover:underline text-blue-600 font-semibold"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="red" class="bi bi-trash" viewBox="0 0 16 16">
              ...
              <div class="p-4 md:p-5 space-y-4">
                <form action="/seminar/add-seminar" method="post" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-2 mb-5">
                        ...
                        <input type="text" id="aktivitas" name="mahasiswa_nim" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-green-200 block w-full p-2.5 "placeholder="Masukkan Aktivitas" required>
                    </div>
                    <div class="grid grid-cols-2 mb-5">
                        <div class="flex w-full h-full  ps-5 items-center text-sm">Nama Mahasiswa</div>
                        <input type="text" id="aktivitas" name="mahasiswa_nama" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-green-200 block w-full p-2.5 "placeholder="Masukkan Aktivitas" required>
                    </div>
                    <div class="grid grid-cols-2 mb-5">
                    ...
                    <div class="grid grid-cols-2 mb-5">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="datepicker" name="waktu_seminar" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-green-200 block w-full p-2.5 px-10"placeholder="Tanggal Dimulai" required> </div>
                    </div>
...
</html><?php /**PATH A:\Codingan\Project Kuliah\Pemrograman Web\sistem-ta\resources\views/seminar/seminar.blade.php ENDPATH**/ ?>