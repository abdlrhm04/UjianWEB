    ...
    <section class="">
      ...
      <div class="grid h-screen grid-cols-2">
        ...
        <div class="h-screen flex flex-col items-center justify-center font-inter ">
            ...
            <form class="max-w-sm mx-auto w-72" action="<?php echo e(route('actionlogin')); ?>" method="post">
              <?php echo csrf_field(); ?>
                <div class="mb-5">
...
</html><?php /**PATH A:\Codingan\Project Kuliah\Pemrograman Web\sistem-ta\resources\views/login.blade.php ENDPATH**/ ?>