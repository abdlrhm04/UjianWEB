        ...
        <div class="grid grid-cols-2 bg-white  w-11/12 h-16 ps-5 items-center">
            ...
            <table class="w-11/12 text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    ...
                    <?php $__currentLoopData = $orasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $i++;
                    ?>
                    <tr>
                        ...
                        <td class="px-6 py-4">
                            <a target="_blank" href="storage/<?php echo e($item->lampiran_orasi); ?>" class="hover:text-gray-700 hover:underline text-blue-600 font-semibold">Laporan Kegiatan</a>
                        </td>
...
</html><?php /**PATH A:\Codingan\Project Kuliah\Pemrograman Web\sistem-ta\resources\views/orasi/orasi.blade.php ENDPATH**/ ?>