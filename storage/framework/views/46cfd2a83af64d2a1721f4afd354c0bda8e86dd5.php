        ...
        <div class="grid grid-cols-2 bg-white  w-11/12 h-16 ps-5 items-center">
            ...
            <table class="w-11/12 text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    ...
                    <?php $__currentLoopData = $pembimbing; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $i++;
                    ?>
                    <tr>
                        ...
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <a href="#"> <?php echo e($item->nama_kegiatan); ?></a>
                        </th>
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        ...
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <?php echo e(ubahFormatTanggal($item->waktu)); ?>

                        </th>
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <?php echo e($item->no_sk); ?>
              ...
              <div class="p-4 md:p-5 space-y-4">
                <form action="/pembimbing/add-pembimbing" method="post" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-2 mb-5">
                        <div class="flex w-full h-full  ps-5 items-center text-sm">Nama Kegiatan</div>
                        <input type="text" id="aktivitas" name="nama_kegiatan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-green-200 block w-full p-2.5 "placeholder="Masukkan NIM" required>
                    </div>
                    <div class="grid grid-cols-2 mb-5">
                    ...
                    <div class="grid grid-cols-2 mb-5">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="datepicker" name="waktu" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-green-200 block w-full p-2.5 px-10"placeholder="Tanggal Dimulai" required> </div>
                    </div>
                    <div class="grid grid-cols-2 mb-5">
...
</html><?php /**PATH A:\Codingan\Project Kuliah\Pemrograman Web\sistem-ta\resources\views/pembimbing/pembimbing.blade.php ENDPATH**/ ?>