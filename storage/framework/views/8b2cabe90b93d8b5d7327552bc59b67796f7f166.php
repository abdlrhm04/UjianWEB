    ...
    <div class="flex ms-72 mt-5 class font-inter flex-col">
        <div class="bg-white  w-11/12 h-32 ps-5 pt-5">
            ...
            <div class="grid grid-cols-3  w-2/3 mt-2">
                <div>
                    <p>Total Aktivitas</p>
                    <span class="flex items-center mt-3">4</span>
                </div>
                <div>
                    <p>Jumlash SKS</p>
                    <span class="flex items-center mt-3">4</span>
            ...
            <table class="w-11/12 text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <?php echo e($item->sks_hasil*$item->jumlah_volume_kegiatan); ?>
...
</html><?php /**PATH A:\Codingan\Project Kuliah\Pemrograman Web\sistem-ta\resources\views/dashboard.blade.php ENDPATH**/ ?>