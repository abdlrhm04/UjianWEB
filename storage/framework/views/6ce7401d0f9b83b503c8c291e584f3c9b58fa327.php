...
<body  >
        ...
        <div class="flex flex-col bg-white  w-11/12 h-11/12 pb-10 ps-5 pt-5">
            <div class="text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700 ">
                <ul class="flex flex-wrap -mb-px">
                    ...
                    <?php if($aktivitas->nama_aktivitas == "Perkuliahan"): ?>
                    <li class="me-2">
            ...
            <div id="container-ringkasan">
                <div class="flex justify-end items-end pt-2">
                    <button  data-modal-target="modal-update" data-modal-toggle="modal-update" type="button"  class="text-gray-600 bg-[#FFFFFF] hover:bg-gray-200  border-2 focus:ring-[#1da1f2]/50 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center dark:focus:ring-[#1da1f2]/55 me-2 mb-2">
                        ...
                        <a href="/aktivitas/delete/<?php echo e($aktivitas->id); ?>" class="text-gray-600 bg-[#FFFFFF] hover:bg-gray-200  border-2 focus:ring-[#1da1f2]/50 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center dark:focus:ring-[#1da1f2]/55 me-2 mb-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-filter" viewBox="0 0 16 16">
                ...
                <div class="grid grid-cols-2  mt-5 ms-5 text-sm w-2/5 text-gray-600">
                    <p>Aktivitas</p>
                    <p class="text-gray-800"><?php echo e($aktivitas->nama_aktivitas); ?></p>
                </div>
                <div class="grid grid-cols-2  mt-5 ms-5 text-sm w-2/5 text-gray-600">
                    <p>Tahun Ajaran</p>
                    <p class="text-gray-800"><?php echo e($aktivitas->tahun_ajaran); ?></p>
                </div>
                <div class="grid grid-cols-2  mt-5 ms-5 text-sm w-2/5 text-gray-600">
                    <p>Periode</p>
                    <p class="text-gray-800"><?php echo e(ubahFormatTanggal($aktivitas->tanggal_mulai)); ?> - <?php echo e(ubahFormatTanggal($aktivitas->tanggal_berakhir)); ?></p>
                </div>
                <div class="grid grid-cols-2  mt-5 ms-5 text-sm w-2/5 text-gray-600">
                    <p>Satuan Hasil</p>
                    <p class="text-gray-800"><?php echo e($aktivitas->sks_hasil); ?> SKS</p>
                </div>
                <div class="grid grid-cols-2  mt-5 ms-5 text-sm w-2/5 text-gray-600">
                    <p>Jumlah Volume Kegiatan</p>
                    <p class="text-gray-800"><?php echo e($aktivitas->jumlah_volume_kegiatan); ?> SKS</p>
                </div>
                <div class="grid grid-cols-2  mt-5 ms-5 text-sm w-2/5 text-gray-600">
                    <p>Angka Kredit</p>
                    <p class="text-gray-800"><?php echo e($aktivitas->angka_kredit); ?> SKS</p>
                </div>
                <div class="grid grid-cols-2  mt-5 ms-5 text-sm w-2/5 text-gray-600">
                    <p>Jumlah Angka Kredit</p>
                    <p class="text-gray-800"><?php echo e($aktivitas->angka_kredit * $aktivitas->jumlah_volume_kegiatan); ?> SKS</p>
                </div>
                <div class="grid grid-cols-2  mt-5 ms-5 text-sm w-2/5 text-gray-600">
                    <p>No. Penugasan</p>
                    <p class="text-gray-800"><?php echo e($aktivitas->no_penugasan); ?></p>
                </div>
                <div class="grid grid-cols-2  mt-5 ms-5 text-sm w-2/5 text-gray-600">
                    <p>Lampiran</p>
                    <a target="_blank" href="/storage/<?php echo e($aktivitas->path_lampiran); ?>" class="hover:text-gray-700 hover:underline text-blue-600 font-semibold"><?php echo e($aktivitas->jenis_lampiran); ?></a>
                </div>
            </div>
            
            <?php if($aktivitas->nama_aktivitas == "Perkuliahan"): ?>                <!---- Table Body ------>
    <div id="container-kelas" class="w-full hidden">
        ...
        <table class="text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <?php $__currentLoopData = $kelas_aktivitas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        <?php echo e($items->kelas_matkul); ?>

                    </th>
                    <td class="px-6 py-4">
                        <?php echo e($items->kelas_nama); ?>

                    </td>
                    <td class="px-6 py-4">
                       <?php echo e(ubahFormatHari($items->kelas_hari)); ?> , <?php echo e($items->kelas_waktu); ?>

                    </td>
                    <td class="px-6 py-4">
                        <?php echo e($items->kelas_sks); ?>
            ...
            <div class="p-4 md:p-5 space-y-4">
              <form action="/aktivitas/add-kelas" method="post" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-2 mb-5">
                    ...
                    <input type="hidden" id="aktivitas" name="id_aktivitas" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-green-200 block w-full p-2.5 " value="<?php echo e($aktivitas->id); ?>"required>
            ...
            <div class="p-4 md:p-5 space-y-4">
              <form action="/aktivitas/update-aktivitas" method="post" enctype="multipart/form-data">
                  ...
                  <div class="grid grid-cols-2 mb-5">
                      ...
                      <input type="text" id="aktivitas" name="nama_aktivitas" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-green-200 block w-full p-2.5 "placeholder="Masukkan Aktivitas"  value="<?php echo e($aktivitas->nama_aktivitas); ?>" required>
                  </div>
                  <div class="grid grid-cols-2 mb-5">
                      ...
                      <select id="tahun-ajaran" name="tahun_ajaran" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" >
                          ...
                          <option <?php if($aktivitas->tahun_ajaran=="Genap 2023/2024"): ?>
                              <?php if(true): echo 'selected'; endif; ?>
                          <?php endif; ?> value="Genap 2023/2024">Genap 2023/2024</option>
                        </select>
                  </div>
                  <div class="grid grid-cols-2 mb-5">
                      ...
                      <div class="relative">
                          ...
                          <input type="text" id="datepicker" name="tanggal_dimulai" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-green-200 block w-full p-2.5 px-10"placeholder="Tanggal Dimulai" required value="<?php echo e($aktivitas->tanggal_mulai); ?>"> </div>
                  </div>
                  <div class="grid grid-cols-2 mb-5">
                      ...
                      <div class="relative">
                          ...
                          <input type="text" id="datepicker" name="tanggal_berakhir"class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-green-200 block w-full p-2.5 px-10"placeholder="Tanggal Berakhir" required value="<?php echo e($aktivitas->tanggal_berakhir); ?>"> </div>
                  </div>
                  <div class="grid grid-cols-2 mb-5">
                      <div class="flex w-full h-full  ps-5 items-center text-sm">Satuan Hasil</div>
                      <input type="number" id="aktivitas" name="satuan_hasil" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-green-200 block w-full p-2.5 "placeholder="Masukkan SKS" value="<?php echo e($aktivitas->sks_hasil); ?>" required>
                  </div>
            <div class="grid grid-cols-2 mb-5">
              <div class="flex w-full h-full  ps-5 items-center text-sm">Jumlah Volume Kegiatan</div>
              <input type="number" id="aktivitas" name="jumlah_volume" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-green-200 block w-full p-2.5 "placeholder="Jumlah Volume Kegiatan" value="<?php echo e($aktivitas->jumlah_volume_kegiatan); ?>" required>
          </div>
          <div class="grid grid-cols-2 mb-5">
              <div class="flex w-full h-full  ps-5 items-center text-sm">Angka Kredit</div>
              <input type="number" id="aktivitas" step=0.1 name="angka_kredit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-green-200 block w-full p-2.5 "placeholder="Angka Kredit" value="<?php echo e($aktivitas->angka_kredit); ?>" required>
          </div>
          <div class="grid grid-cols-2 mb-5">
              <div class="flex w-full h-full  ps-5 items-center text-sm">No. Penugasan</div>
              <input type="text" id="aktivitas" name="no_tugas" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-green-200 block w-full p-2.5 "placeholder="XX/XXX/XXXX" value="<?php echo e($aktivitas->no_penugasan); ?>" required>
          </div>
          <input type="hidden" id="aktivitas" name="id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-green-200 block w-full p-2.5 "placeholder="XX/XXX/XXXX" value="<?php echo e($aktivitas->id); ?>" required>
    </div>
            <!-- Modal footer -->
            <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
...
</html><?php /**PATH A:\Codingan\Project Kuliah\Pemrograman Web\sistem-ta\resources\views/aktivitas/detail.blade.php ENDPATH**/ ?>