            ...
            <table class="w-11/12 text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    ...
                    <tr>
                        ...
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <a href="#"> <?php echo e($item->jabatan); ?></a>
                        </th>
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <?php echo e(ubahFormatTanggal($item->periode_awal)); ?>

                        </th>
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <?php echo e(ubahFormatTanggal($item->periode_akhir)); ?>
                        ...
                        <td class="px-6 py-4">
                            <a target="_blank" href="storage/<?php echo e($item->path_lampiran); ?>" class="hover:text-gray-700 hover:underline text-blue-600 font-semibold">Lampiran Jabatan</a>
                        </td>
...
</html><?php /**PATH M:\kuliah\SEMESTER 5\Prak Web\TB\sistem-ta\resources\views/jabatan/jabatan.blade.php ENDPATH**/ ?>