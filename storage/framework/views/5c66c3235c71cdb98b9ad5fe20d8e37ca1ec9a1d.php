        ...
        <div class="grid grid-cols-2 bg-white  w-11/12 h-16 ps-5 items-center">
            ...
            <table class="w-11/12 text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    ...
                    <?php $__currentLoopData = $tugasakhir; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $i++;
                    ?>
                    <tr>
                        ...
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <?php echo e($item->jenis_bimbingan); ?>
                        ...
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <?php echo e($item->jenis_pembimbing); ?>
...
</html><?php /**PATH A:\Codingan\Project Kuliah\Pemrograman Web\sistem-ta\resources\views/tugasakhir/tugasakhir.blade.php ENDPATH**/ ?>