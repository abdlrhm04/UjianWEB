    ...
    <aside id="logo-sidebar" class="border-r-4 border-black fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 font-inter" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-blue-200 pt-10"> <!-- Ganti background dengan warna abu-abu -->
            ...
            <ul class="space-y-2 font-medium">
               <li>
                  <a href="/" class="{{ (request()->is('profil')) ? 'text-green-400' : 'text-gray-900'}} flex items-center p-2  rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <li>
                  <a href="/jabatan" class="{{ (request()->is('jabatan*')) ? 'text-green-400' : 'text-blue-900'}}  flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
